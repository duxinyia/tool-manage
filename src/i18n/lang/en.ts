...
export default {
	router: {
		...
		systemMenu: 'purchasing group maintenance',
		systemRole: 'project group maintenance',
		systemUser: 'basic data',
		systemDept: 'model and project code maintenance',
		menu: 'task list',
		menu1: 'menu1',
		menu11: 'menu11',
		menu12: 'menu12',
		...
		menu13: 'menu13',
		menu2: 'menu2',
		funIndex: 'requisition management',
